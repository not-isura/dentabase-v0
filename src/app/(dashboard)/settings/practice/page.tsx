  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="font-semibold text-[hsl(258_46%_25%)]">Clinic Operations</span>
      </div>

      <Card className="bg-white">
        <CardHeader>
          <CardTitle className="text-[hsl(258_46%_25%)]">Clinic Operations</CardTitle>
        ...
        <CardContent>
          <div className="flex flex-col items-center gap-4 py-10 text-[hsl(258_22%_50%)]">
            ...
            <p className="max-w-md text-center text-sm">
              We&apos;re still wiring up clinic workflows. Check back soon for scheduling, service management, and other
