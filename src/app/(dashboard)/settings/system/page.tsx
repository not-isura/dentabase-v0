...
import { Settings, ArrowLeft, ChevronRight, Database, Mail, Shield } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="text-[hsl(258_46%_25%)] font-semibold">System Configuration</span>
      </div>
